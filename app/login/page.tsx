      ...
      >
        ...
        >
          <motion.button
            ...
            onClick={async () => {
              setLoading(true);
              console.log('GitHub OAuth clicked, redirectTo:', `${window.location.origin}/auth/callback`);
          ...
          <motion.button
            ...
            onClick={async () => {
              setLoading(true);
              console.log('Google OAuth clicked, redirectTo:', `${window.location.origin}/auth/callback`);
              const { data, error } = await supabase.auth.signInWithOAuth({ 
                provider: 'google', 
                options: { 
                  redirectTo: `${window.location.origin}/auth/callback`
